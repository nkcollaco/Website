...
```
This shows a boxplot that was created using seaborn package in python.It shows the differences between percentage of a county's population with Diabetes and if the county is catagorized as mostly urban or mostly rural.Python has a wide variety of uses and can visualize data just like R can. 
